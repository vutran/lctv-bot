...
// import commands
import { githubLink, help, project, status, views } from './commands'
...
export default class Bot {
  ...
  constructor(config) {
    ...
    this.followers.on('lctv:follower:new', this.handleNewFollower.bind(this))
    ...
    this.client.on('lctv:mentions:all', this.handleAllMentions.bind(this))
    this.client.on('lctv:mentions:self', this.handleSelfMentions.bind(this))
   ...
   * @param Stanza stanza
   */
  handleAllMentions(username, stanza) {
   ...
   * @param Stanza stanza
   */
  handleSelfMentions(username, stanza) {
